...
class Hotel {
	/**
	 * we are using enum for customer types. In hotel reservation system there are
	 * two types of customer 1) Regular 2) reward
	 */
	enum customer {
		REGULAR, REWARD;
	}
	...
	/**
	 * 1) The get method returns the variable value, and the set method sets the
	 * value. 2) "this" keyword is used to refer to the current object.
	 */

	/**
	 * The getSpecialAvgRate method returns the value of the variable
	 * specialAvgRate.
	 * 
	...
	/**
	 * The setAvgRate method takes a parameter (specialAvgRate) and assigns it to
	 * the specialAvgRate variable
	 * 
	 * @param specialAvgRate taking in this Hotel reservation system.
	 */
	...
	/**
	 * The setAvgRate method takes a parameter (avgRate) and assigns it to the
	 * avgRate variable
	 * 
	...
	/**
	 * The setHotelName method takes a parameter (hotelName) and assigns it to the
	 * hotelName variable
	 * 
	...
	/**
	 * The setRating method takes a parameter (rating) and assigns it to the rating
	 * variable
	 * 
	...
	/**
	 * The setWeekdayRate method takes a parameter (weekdayRate) and assigns it to
	 * the weekdayRate variable
	 * 
	...
	/**
	 * The setWeekendRate method takes a parameter (weekendRate) and assigns it to
	 * the weekendRate variable
	 * 
	...
	/**
	 * The getSpecialWeekdayRate method returns the value of the variable
	 * specialWeekdayRate.
	 * 
	...
	/**
	 * The setSpecialWeekdayRate method takes a parameter (specialWeekdayRate) and
	 * assigns it to the specialWeekdayRate variable
	 * 
	...
	/**
	 * The getSpecialWeekendRate method returns the value of the variable
	 * specialWeekendRat.
	 * 
	...
	/**
	 * The setSpecialWeekendRate method takes a parameter (specialWeekendRate) and
	 * assigns it to the specialWeekendRate variable
	 * 
